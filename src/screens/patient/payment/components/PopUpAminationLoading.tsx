...
import moduleName from '../../../../assets/animations/loading.json'
import {fontFamilies} from '../../../../constants/fontFamilies';

const url = '../../../../assets/animations/loading.json';
...
const PopUpAnimationLoading: React.FC<PopUpAnimationProps> = ({
  visible,
  onComplete,
  content
}) => {
...
export default PopUpAnimationLoading;
